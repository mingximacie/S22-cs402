...
public class GetCitation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		CitationDao od1  =  new CitationDao();
		
		Citation ob1 = od1.getCitation(author);
		...
		RequestDispatcher rd = request.getRequestDispatcher("GetCitation.jsp");
