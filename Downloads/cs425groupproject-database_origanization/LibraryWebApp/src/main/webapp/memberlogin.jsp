...
<head>
<meta charset="utf-8">
<title>Hi Library Member! Welcome back to Group 6 Library!</title>
<style>
.button {
  border: none;
  color: white;
...
<body>
    <div style="text-align: center">
        ...
        <form action="login" method="post">
            ...
            <br><br>
            <br>Login as a library member.
            <br><br>           
            <button type="button" class="button button1" onclick="document.location='memberhome.jsp'">Login</button>
